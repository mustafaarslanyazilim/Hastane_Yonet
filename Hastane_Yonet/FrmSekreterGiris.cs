...
namespace Hastane_Yonet
{
    public partial class FrmSekreterGiris : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("Select * From Tbl_Sekreter where SekreterTC=@a1 and SekreterSifre=@a2", bgl.baglanti());
            ...
            if (dr.Read())
            {
                ...
                frs.SekreterTC = MskTcKimlikNo.Text; //sekreter detaydan çekiyoruz.
                frs.Show();
                this.Hide();
            }
            else
